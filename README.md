...
Live walkthrough is also available on request, covering: architecture, the `mart_purchase_attribution` model, the streaming idempotency demo, and the dashboard.